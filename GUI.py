...
main_label = Label(root, text='Video Stream')
...
def videoStream():
    '''
    Create a simple setup for testing video stream with GUL
    :return: None
    '''
    global show_video
...
start_btn = Button(root, text='Start', command=startClicked)
stop_btn = Button(root, text='Stop', command=stopClicked)
check_var = IntVar()
check_list = Checkbutton(root, text='Test',variable=check_var)
